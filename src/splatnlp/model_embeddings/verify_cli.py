...
from splatnlp.model_embeddings.verify import verify_embeddings_vs_logits


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Verify pooled embeddings match forward logits."
    )
    ...
    metrics = verify_embeddings_vs_logits(
        model,
        df,
        vocab,
        weapon_vocab,
